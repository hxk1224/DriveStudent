...
package com.drive.student.util.cropper.cropwindow.edge;
...
public enum Edge {
    ...
    public void adjustCoordinate(float aspectRatio) {
        ...
        switch (this) {
            case LEFT:
                mCoordinate = com.drive.student.util.cropper.util.AspectRatioUtil.calculateLeft(top, right, bottom, aspectRatio);
                break;
            case TOP:
                mCoordinate = com.drive.student.util.cropper.util.AspectRatioUtil.calculateTop(left, right, bottom, aspectRatio);
                break;
            case RIGHT:
                mCoordinate = com.drive.student.util.cropper.util.AspectRatioUtil.calculateRight(left, top, bottom, aspectRatio);
                break;
            case BOTTOM:
                mCoordinate = com.drive.student.util.cropper.util.AspectRatioUtil.calculateBottom(left, top, right, aspectRatio);
                break;
        }
    }
        ...
        switch (this) {
            case LEFT:
                if (edge.equals(Edge.TOP)) {
                    ...
                    float left = com.drive.student.util.cropper.util.AspectRatioUtil.calculateLeft(top, right, bottom, aspectRatio);
            ...
            case TOP:
                if (edge.equals(Edge.LEFT)) {
                    ...
                    float top = com.drive.student.util.cropper.util.AspectRatioUtil.calculateTop(left, right, bottom, aspectRatio);
                    return isOutOfBounds(top, left, bottom, right, imageRect);
            ...
            case RIGHT:
                if (edge.equals(Edge.TOP)) {
                    ...
                    float right = com.drive.student.util.cropper.util.AspectRatioUtil.calculateRight(left, top, bottom, aspectRatio);
                    return isOutOfBounds(top, left, bottom, right, imageRect);
                } else if (edge.equals(Edge.BOTTOM)) {
                    float bottom = imageRect.bottom;
                    float top = Edge.TOP.getCoordinate() - offset;
            ...
            case BOTTOM:
                if (edge.equals(Edge.LEFT)) {
                    ...
                    float bottom = com.drive.student.util.cropper.util.AspectRatioUtil.calculateBottom(left, top, right, aspectRatio);
                    return isOutOfBounds(top, left, bottom, right, imageRect);
                } else if (edge.equals(Edge.RIGHT)) {
                    float right = imageRect.right;
                    float left = Edge.LEFT.getCoordinate() - offset;
     ...
     * @return the partAmount (in pixels) that this coordinate was changed (i.e. the
     ...
     * rectangle. The margins come inside the actual frame by SNAPRADIUS partAmount;
