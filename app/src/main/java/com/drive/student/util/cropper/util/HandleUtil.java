...
import com.drive.student.util.cropper.cropwindow.CropOverlayView;
import com.drive.student.util.cropper.cropwindow.handle.Handle;
...
public class HandleUtil {
    ...
    public static float getTargetRadius(Context context) {
        ...
        final float targetRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, TARGET_RADIUS_DP, context.getResources().getDisplayMetrics());
        return targetRadius;
    }
