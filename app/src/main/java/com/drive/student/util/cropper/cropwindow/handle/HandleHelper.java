...
import com.drive.student.util.cropper.cropwindow.edge.EdgePair;
...
abstract class HandleHelper {
    ...
    private float getAspectRatio(float x, float y) {
        ...
        final float aspectRatio = com.drive.student.util.cropper.util.AspectRatioUtil.calculateAspectRatio(left, top, right, bottom);
