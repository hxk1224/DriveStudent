...
package com.drive.student.util.cropper.cropwindow;
...
public class CropOverlayView extends View {
    ...
    private static final float DEFAULT_CORNER_THICKNESS_DP = com.drive.student.util.cropper.util.PaintUtil.getCornerThickness();
    private static final float DEFAULT_LINE_THICKNESS_DP = com.drive.student.util.cropper.util.PaintUtil.getLineThickness();
    ...
    private com.drive.student.util.cropper.cropwindow.handle.Handle mPressedHandle;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.getCoordinate(), com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.getCoordinate(), com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.getCoordinate(), com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.getCoordinate(), mBorderPaint);
    ...
    private void init(Context context) {
        ...
        mHandleRadius = com.drive.student.util.cropper.util.HandleUtil.getTargetRadius(context);

        mSnapRadius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, SNAP_RADIUS_DP, displayMetrics);

        mBorderPaint = com.drive.student.util.cropper.util.PaintUtil.newBorderPaint(context);
        mGuidelinePaint = com.drive.student.util.cropper.util.PaintUtil.newGuidelinePaint();
        mBackgroundPaint = com.drive.student.util.cropper.util.PaintUtil.newBackgroundPaint(context);
        mCornerPaint = com.drive.student.util.cropper.util.PaintUtil.newCornerPaint(context);
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            // vice-versa.
            if (com.drive.student.util.cropper.util.AspectRatioUtil.calculateAspectRatio(bitmapRect) > mTargetAspectRatio) {

                com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.setCoordinate(bitmapRect.top);
                com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.setCoordinate(bitmapRect.bottom);

                final float centerX = getWidth() / 2f;

                // Limits the aspect ratio to no less than 40 wide or 40 tall
                final float cropWidth = Math.max(com.drive.student.util.cropper.cropwindow.edge.Edge.MIN_CROP_LENGTH_PX, com.drive.student.util.cropper.util.AspectRatioUtil.calculateWidth(com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.getCoordinate(), com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.getCoordinate(), mTargetAspectRatio));

                // Create new TargetAspectRatio if the original one does not fit
                // the screen
                if (cropWidth == com.drive.student.util.cropper.cropwindow.edge.Edge.MIN_CROP_LENGTH_PX) {
                    mTargetAspectRatio = (com.drive.student.util.cropper.cropwindow.edge.Edge.MIN_CROP_LENGTH_PX) / (com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.getCoordinate() - com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.getCoordinate());
                }

                final float halfCropWidth = cropWidth / 2f;
                com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.setCoordinate(centerX - halfCropWidth);
                com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.setCoordinate(centerX + halfCropWidth);

            } else {

                com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.setCoordinate(bitmapRect.left);
                com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.setCoordinate(bitmapRect.right);

                final float centerY = getHeight() / 2f;

                // Limits the aspect ratio to no less than 40 wide or 40 tall
                final float cropHeight = Math.max(com.drive.student.util.cropper.cropwindow.edge.Edge.MIN_CROP_LENGTH_PX, com.drive.student.util.cropper.util.AspectRatioUtil.calculateHeight(com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.getCoordinate(), com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.getCoordinate(), mTargetAspectRatio));

                // Create new TargetAspectRatio if the original one does not fit
                // the screen
                if (cropHeight == com.drive.student.util.cropper.cropwindow.edge.Edge.MIN_CROP_LENGTH_PX) {
                    mTargetAspectRatio = (com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.getCoordinate() - com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.getCoordinate()) / com.drive.student.util.cropper.cropwindow.edge.Edge.MIN_CROP_LENGTH_PX;
                }

                final float halfCropHeight = cropHeight / 2f;
                com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.setCoordinate(centerY - halfCropHeight);
                com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.setCoordinate(centerY + halfCropHeight);
            }

        } else { // ... do not fix aspect ratio...

            // Initialize crop window to have 2% padding w/ respect to image.
            final float horizontalPadding = 0.02f * bitmapRect.width();
            final float verticalPadding = 0.02f * bitmapRect.height();

            com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.setCoordinate(bitmapRect.left + horizontalPadding);
            com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.setCoordinate(bitmapRect.top + verticalPadding);
            com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.setCoordinate(bitmapRect.right - horizontalPadding);
            com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.setCoordinate(bitmapRect.bottom - verticalPadding);
        }
    }
    ...
    public static boolean showGuidelines() {
        return !((Math.abs(com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.getCoordinate() - com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.getCoordinate()) < DEFAULT_SHOW_GUIDELINES_LIMIT) || (Math.abs(com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.getCoordinate() - com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.getCoordinate()) < DEFAULT_SHOW_GUIDELINES_LIMIT));
    }

    private void drawRuleOfThirdsGuidelines(Canvas canvas) {

        final float left = com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.getCoordinate();
        final float top = com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.getCoordinate();
        final float right = com.drive.student.util.cropper.cropwindow.edge.Edge.RIGHT.getCoordinate();
        final float bottom = com.drive.student.util.cropper.cropwindow.edge.Edge.BOTTOM.getCoordinate();

        // Draw vertical guidelines.
        final float oneThirdCropWidth = com.drive.student.util.cropper.cropwindow.edge.Edge.getWidth() / 3;
        ...
        final float oneThirdCropHeight = com.drive.student.util.cropper.cropwindow.edge.Edge.getHeight() / 3;
    ...
    private void onActionDown(float x, float y) {
        ...
        mPressedHandle = com.drive.student.util.cropper.util.HandleUtil.getPressedHandle(x, y, left, top, right, bottom, mHandleRadius);
        ...
        mTouchOffset = com.drive.student.util.cropper.util.HandleUtil.getOffset(mPressedHandle, x, y, left, top, right, bottom);
