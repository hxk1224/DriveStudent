...
package com.drive.student.util.cropper;
...
public class CropImageView extends FrameLayout {
    ...
    private com.drive.student.util.cropper.cropwindow.CropOverlayView mCropOverlayView;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mBitmap != null) {
            final Rect bitmapRect = com.drive.student.util.cropper.util.ImageViewUtil.getBitmapRectCenterInside(mBitmap, this);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mBitmap != null) {
            ...
            final Rect bitmapRect = com.drive.student.util.cropper.util.ImageViewUtil.getBitmapRectCenterInside(mBitmap.getWidth(), mBitmap.getHeight(), mLayoutWidth, mLayoutHeight);
            mCropOverlayView.setBitmapRect(bitmapRect);
    ...
    public Bitmap getCroppedImage() {
        ...
        final Rect displayedImageRect = com.drive.student.util.cropper.util.ImageViewUtil.getBitmapRectCenterInside(mBitmap, mImageView);
        ...
        final float cropWindowX = com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.getCoordinate() - displayedImageRect.left;
        final float cropWindowY = com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.getCoordinate() - displayedImageRect.top;
        final float cropWindowWidth = com.drive.student.util.cropper.cropwindow.edge.Edge.getWidth();
        final float cropWindowHeight = com.drive.student.util.cropper.cropwindow.edge.Edge.getHeight();
    ...
    public RectF getActualCropRect() {
        ...
        // Get crop window position relative to the displayed image.
        final float displayedCropLeft = com.drive.student.util.cropper.cropwindow.edge.Edge.LEFT.getCoordinate() - displayedImageRect.left;
        final float displayedCropTop = com.drive.student.util.cropper.cropwindow.edge.Edge.TOP.getCoordinate() - displayedImageRect.top;
        final float displayedCropWidth = com.drive.student.util.cropper.cropwindow.edge.Edge.getWidth();
        final float displayedCropHeight = com.drive.student.util.cropper.cropwindow.edge.Edge.getHeight();
    ...
    private void init(Context context) {
        ...
        mCropOverlayView = (com.drive.student.util.cropper.cropwindow.CropOverlayView) v.findViewById(R.id.CropOverlayView);
