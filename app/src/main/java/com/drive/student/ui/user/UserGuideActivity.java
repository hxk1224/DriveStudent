...
public class UserGuideActivity extends ActivitySupport implements OnClickListener {
...
//				09-10 11:13:01.970: E/ContactUsActivity(14349): onLoadResource-->url === http://hm.baidu.com/hm.js?039d115effb1a43fa3c66e592c74aa5e
    ...
    private void handlerSuccess(String json) {
        ...
        try {
            ...
            String webUrl;
            if (json.contains("operationUrl")) {
                webUrl = data.getString("operationUrl");
            } else {
                webUrl = data.getString("contactUrl");
            }
