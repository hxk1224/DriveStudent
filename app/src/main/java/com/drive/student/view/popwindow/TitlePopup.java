package com.drive.student.view.popwindow;
...
public class TitlePopup extends PopupWindow {
    ...
    public void show(View view) {
        ...
        // 显示弹窗的位置
        int x = mScreenWidth - LIST_PADDING - (getWidth() / 2);
        int y = mRect.bottom;
    ...
    private void populateActions() {
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                TextView textView = com.drive.student.view.popwindow.ViewHolder.get(convertView, R.id.txt_title);
                // // 设置文本域的范围
