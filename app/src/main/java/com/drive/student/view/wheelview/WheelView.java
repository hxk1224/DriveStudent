...
package com.drive.student.view.wheelview;
...
import com.drive.student.view.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.user_wheel_bg;
    private int wheelForeground = R.drawable.user_wheel_val;
    ...
    // Scrolling
    private com.drive.student.view.wheelview.WheelScroller scroller;
    ...
    private void initData(Context context) {
        scroller = new com.drive.student.view.wheelview.WheelScroller(getContext(), scrollingListener);
    }

    // Scrolling listener
    com.drive.student.view.wheelview.WheelScroller.ScrollingListener scrollingListener = new com.drive.student.view.wheelview.WheelScroller.ScrollingListener() {
        @Override
        ...
        public void onJustify() {
            if (Math.abs(scrollingOffset) > com.drive.student.view.wheelview.WheelScroller.MIN_DELTA_FOR_SCROLLING) {
     ...
     * Actual partAmount of visible items depends on wheel layout parameters.
