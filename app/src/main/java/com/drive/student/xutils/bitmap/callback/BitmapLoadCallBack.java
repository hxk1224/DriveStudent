...
package com.drive.student.xutils.bitmap.callback;
...
public abstract class BitmapLoadCallBack<T extends View> {
     ...
     * @param config
     */
    public abstract void onLoadCompleted(T container, String uri, Bitmap bitmap, BitmapDisplayConfig config, com.drive.student.xutils.bitmap.callback.BitmapLoadFrom from);
    ...
    private com.drive.student.xutils.bitmap.callback.BitmapSetter<T> bitmapSetter;

    public void setBitmapSetter(com.drive.student.xutils.bitmap.callback.BitmapSetter<T> bitmapSetter) {
