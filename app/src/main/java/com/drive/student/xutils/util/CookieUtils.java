...
package com.drive.student.xutils.util;
...
//		editor.commit();
//		LogUtil.saveLog("cookieUtils_clear", cookies + "");
...
//				cookies.remove(name);
//				LogUtil.saveLog("cookieUtils_clearExpired", cookies + "");
//				// Clear cookies from persistent store
//				editor.remove(COOKIE_NAME_PREFIX + name);
//
...
//			}
        ...
        // if (clearedAny) {
        // editor.putString(COOKIE_NAME_STORE, TextUtils.join(",",
        // cookies.keySet()));
        // }
        // editor.commit();
        return clearedAny;
