...
package com.drive.student.xutils.http;
...
public class HttpHandler<T> extends com.drive.student.xutils.task.PriorityAsyncTask<Object, Object, Void> implements com.drive.student.xutils.http.callback.RequestCallBackHandler {
    ...
    public void setHttpRedirectHandler(com.drive.student.xutils.http.callback.HttpRedirectHandler httpRedirectHandler) {
    ...
    private com.drive.student.xutils.http.callback.RequestCallBack<T> callback;
    ...
    public HttpHandler(AbstractHttpClient client, HttpContext context, String charset, com.drive.student.xutils.http.callback.RequestCallBack<T> callback) {
        this.client = client;
    ...
    public void setRequestCallBack(com.drive.student.xutils.http.callback.RequestCallBack<T> callback) {
        this.callback = callback;
    }

    public com.drive.student.xutils.http.callback.RequestCallBack<T> getRequestCallBack() {
        return this.callback;
    }

    // 执行请求
    @SuppressWarnings("unchecked")
    private com.drive.student.xutils.http.ResponseInfo<T> sendRequest(HttpRequestBase request) throws HttpException {
    ...
    protected Void doInBackground(Object... params) {
        ...
        try {
            ...
            com.drive.student.xutils.http.ResponseInfo<T> responseInfo = sendRequest(request);
    ...
    protected void onProgressUpdate(Object... values) {
        ...
        switch ((Integer) values[0]) {
            ...
            case UPDATE_SUCCESS:
                ...
                callback.onSuccess((com.drive.student.xutils.http.ResponseInfo<T>) values[1]);
                break;
            default:
                break;
        }
    ...
    @SuppressWarnings("unchecked")
    private com.drive.student.xutils.http.ResponseInfo<T> handleResponse(HttpResponse response) throws HttpException, IOException {
        if (response == null) {
        ...
        if (statusCode < 300) {
            ...
            if (entity != null) {
                ...
                if (isDownloadingFile) {
                    autoResume = autoResume && com.drive.student.xutils.util.OtherUtils.isSupportRange(response);
                    String responseFileName = autoRename ? com.drive.student.xutils.util.OtherUtils.getFileNameFromHttpResponse(response) : null;
                    com.drive.student.xutils.http.callback.FileDownloadHandler downloadHandler = new com.drive.student.xutils.http.callback.FileDownloadHandler();
                    result = downloadHandler.handleEntity(entity, this, fileSavePath, autoResume, responseFileName);
                } else {
                    com.drive.student.xutils.http.callback.StringDownloadHandler downloadHandler = new com.drive.student.xutils.http.callback.StringDownloadHandler();
            ...
            return new com.drive.student.xutils.http.ResponseInfo<T>(response, (T) result, false);
        } else if (statusCode == 301 || statusCode == 302) {
            if (httpRedirectHandler == null) {
                httpRedirectHandler = new com.drive.student.xutils.http.callback.DefaultHttpRedirectHandler();
            }
