...
import com.drive.student.xutils.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.drive.student.xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.drive.student.xutils.db.table.Id>();

    /* package */
    static synchronized com.drive.student.xutils.db.table.Id getId(Class<?> entityType) {
        if (Object.class.equals(entityType)) {
        ...
        com.drive.student.xutils.db.table.Id id = new com.drive.student.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.drive.student.xutils.db.table.Id id = getId(entityType);
