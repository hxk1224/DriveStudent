...
package com.drive.student.xutils.bitmap.download;
...
public class DefaultDownloader extends com.drive.student.xutils.bitmap.download.Downloader {
    ...
    public long downloadToStream(String uri, OutputStream outputStream, final BitmapUtils.BitmapLoadTask<?> task) {
        ...
        com.drive.student.xutils.util.OtherUtils.trustAllHttpsURLConnection();
        ...
        try {
            ...
            com.drive.student.xutils.util.IOUtils.closeQuietly(bis);
        }
        return result;
    }
}
