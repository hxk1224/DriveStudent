...
public class DbModelSelector {
    ...
    private com.drive.student.xutils.db.sqlite.WhereBuilder having;

    private Selector selector;

    private DbModelSelector(Class<?> entityType) {
        selector = com.drive.student.xutils.db.sqlite.Selector.from(entityType);
    }
    ...
    public DbModelSelector where(com.drive.student.xutils.db.sqlite.WhereBuilder whereBuilder) {
    ...
    public DbModelSelector and(com.drive.student.xutils.db.sqlite.WhereBuilder where) {
        selector.and(where);
        return this;
    }
    ...
    public DbModelSelector or(com.drive.student.xutils.db.sqlite.WhereBuilder where) {
        selector.or(where);
        return this;
    }
    ...
    public DbModelSelector having(com.drive.student.xutils.db.sqlite.WhereBuilder whereBuilder) {
