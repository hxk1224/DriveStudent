...
package com.drive.student.xutils.util.core.compatible;
 ...
 * This class is likely to be faster than {@link java.util.Stack} when used as a
 * stack, and faster than {@link java.util.LinkedList} when used as a queue.
 * <p/>
 * <p/>
 ...
 * the iterator will generally throw a
 ...
 * the {@link java.util.Collection} and {@link java.util.Iterator} interfaces.
 *
...
public class ArrayDeque<E> extends AbstractCollection<E> implements Deque<E>, Cloneable, java.io.Serializable {
     ...
     * semantics differ from those of {@link java.util.List#remove(int)}.
     *
