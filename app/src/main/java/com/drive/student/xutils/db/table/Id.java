...
import com.drive.student.xutils.db.annotation.NoAutoIncrement;
...
public class Id extends Column {
    ...
    public boolean isAutoIncrement() {
        if (!isAutoIncrementChecked) {
            ...
            isAutoIncrement = columnField.getAnnotation(NoAutoIncrement.class) == null && AUTO_INCREMENT_TYPES.contains(columnFieldClassName);
        }
