...
public class Foreign extends Column {
    ...
    /* package */Foreign(Class<?> entityType, Field field) {
        ...
        Class<?> foreignColumnType = com.drive.student.xutils.db.table.TableUtils.getColumnOrId(getForeignEntityType(), foreignColumnName).columnField.getType();
            ...
            if (columnType.equals(ForeignLazyLoader.class)) {
                ...
                try {
                    ...
                    if (foreignEntities.size() > 0) {
                        ...
                        Column column = com.drive.student.xutils.db.table.TableUtils.getColumnOrId(foreignEntityType, foreignColumnName);
                ...
                try {
                    Column column = com.drive.student.xutils.db.table.TableUtils.getColumnOrId(columnType, foreignColumnName);
