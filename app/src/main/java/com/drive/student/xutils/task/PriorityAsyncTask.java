...
package com.drive.student.xutils.task;
 ...
 * Time: 上午11:25
 */
public abstract class PriorityAsyncTask<Params, Progress, Result> implements com.drive.student.xutils.task.TaskHandler {
    ...
    public static final Executor sDefaultExecutor = new com.drive.student.xutils.task.PriorityExecutor();
    ...
    public final PriorityAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        ...
        exec.execute(new com.drive.student.xutils.task.PriorityRunnable(priority, mFuture));
    ...
    public static void execute(Runnable runnable, Priority priority) {
        sDefaultExecutor.execute(new com.drive.student.xutils.task.PriorityRunnable(priority, runnable));
    }
