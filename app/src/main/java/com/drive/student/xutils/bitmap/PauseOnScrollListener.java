...
public class PauseOnScrollListener implements OnScrollListener {
    ...
    private com.drive.student.xutils.task.TaskHandler taskHandler;
     ...
     */
    public PauseOnScrollListener(com.drive.student.xutils.task.TaskHandler taskHandler, boolean pauseOnScroll, boolean pauseOnFling) {
     ...
     */
    public PauseOnScrollListener(com.drive.student.xutils.task.TaskHandler taskHandler, boolean pauseOnScroll, boolean pauseOnFling, OnScrollListener customListener) {
