...
public class Column {
    ...
    /* package */Column(Class<?> entityType, Field field) {
        ...
        this.columnName = com.drive.student.xutils.db.table.ColumnUtils.getColumnNameByField(field);
        if (this.columnConverter != null) {
            this.defaultValue = this.columnConverter.getFieldValue(com.drive.student.xutils.db.table.ColumnUtils.getColumnDefaultValue(field));
        } else {
            this.defaultValue = null;
        }
        this.getMethod = com.drive.student.xutils.db.table.ColumnUtils.getColumnGetMethod(entityType, field);
        this.setMethod = com.drive.student.xutils.db.table.ColumnUtils.getColumnSetMethod(entityType, field);
    }
