...
package com.drive.student.xutils.util.core;
...
import com.drive.student.xutils.util.core.compatible.ArrayDeque;
...
public abstract class CompatibleAsyncTask<Params, Progress, Result> {
     ...
     * time in inquiryCode order. This serialization is global to a particular
     * process.
     */
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link CompatibleAsyncTask#onPostExecute} has
         * finished.
         */
        FINISHED,
    }
     ...
     * parallel. If you truly want parallel execution, you can use the
     * {@link #executeOnExecutor} version of this method with
     * {@link #THREAD_POOL_EXECUTOR}; however, see commentary there for warnings
     * on its use.
     * <p/>
     * <p/>
     ...
     *                               {@link CompatibleAsyncTask.Status#RUNNING} or
     ...
     * loss and stability issues. Such changes are best executed in inquiryCode; to
