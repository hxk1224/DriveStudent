...
package com.drive.student.xutils.db.table;
...
import com.drive.student.xutils.db.annotation.Check;
import com.drive.student.xutils.db.annotation.Column;
import com.drive.student.xutils.db.annotation.Finder;
import com.drive.student.xutils.db.annotation.Foreign;
import com.drive.student.xutils.db.annotation.Id;
import com.drive.student.xutils.db.annotation.NotNull;
import com.drive.student.xutils.db.annotation.Transient;
import com.drive.student.xutils.db.annotation.Unique;
import com.drive.student.xutils.db.converter.ColumnConverter;
import com.drive.student.xutils.db.converter.ColumnConverterFactory;
import com.drive.student.xutils.db.sqlite.FinderLazyLoader;
import com.drive.student.xutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.drive.student.xutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.drive.student.xutils.db.table.Finder finderColumn) {
