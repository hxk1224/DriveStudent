...
package com.drive.student.xutils.http.client.util;
...
public class URLEncodedUtils {
    ...
    private static String encodeFormFields(final String content, final String charset) {
        ...
        return urlencode(content, charset != null ? Charset.forName(charset) : Charset.forName(HTTP.UTF_8), URLENCODER, true);
    }
